...
## LET’S GET STARTED!!!
You can take a look at the entire SQL code [Here](https://github.com/Korede34/DATA-CLEANING-PROJECT-WITH-SQL/blob/main/FifaDataQuery.sql) on my GitHub profile.
